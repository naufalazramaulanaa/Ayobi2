...
const RichTextEditorInner: React.FC<Props> = ({ value, onChange, placeholder, className }) => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: "prose dark:prose-invert max-w-none min-h-[160px] p-3 border rounded-md focus:outline-none",
      },
    },
  })
  ...
  if (!editor || !editorMounted) return null
